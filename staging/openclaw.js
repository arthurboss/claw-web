...
// end include: /tmp/tmp74v2w21n.js
...
var ASM_CONSTS = {
 ...
 733683: ($0) => { if (window.audioWorkletNode) { window.audioWorkletNode.port.postMessage(JSON.parse(UTF8ToString($0))); } },  
 733792: () => { console.log('[Debug] m_videoPlatform is NULL!'); },  
 733845: () => { var canvas = document.getElementById('canvas'); return canvas ? canvas.width : 640; },  
 733933: () => { var canvas = document.getElementById('canvas'); return canvas ? canvas.height : 480; },  
 734022: ($0, $1) => { if (typeof triggerHaptic === 'function') { triggerHaptic($0, UTF8ToString($1)); } },  
 734108: ($0, $1, $2, $3) => { if (typeof triggerHapticCustom === 'function') { triggerHapticCustom($0, $1, $2, $3); } },  
 734200: ($0) => { if (typeof setHapticEnabled === 'function') { setHapticEnabled($0); } },  
 734274: ($0) => { try { localStorage.setItem('claw-web:saves', UTF8ToString($0)); return 1; } catch (e) { console.error('[SaveBridge] Save error:', e); return 0; } },  
 734424: () => { try { var jsonStr = localStorage.getItem('claw-web:saves'); if (!jsonStr) return 0; var lengthBytes = lengthBytesUTF8(jsonStr) + 1; var ptr = _malloc(lengthBytes); stringToUTF8(jsonStr, ptr, lengthBytes); return ptr; } catch (e) { console.warn('[SaveBridge] Load error:', e); return 0; } },  
 734716: () => { try { return localStorage.getItem('claw-web:saves') ? 1 : 0; } catch (e) { return 0; } },  
 734807: () => { try { localStorage.removeItem('claw-web:saves'); return 1; } catch (e) { console.error('[SaveBridge] Delete error:', e); return 0; } },  
 734944: () => { if (typeof window.webglBridge !== 'undefined' && window.webglBridge.cleanup) { window.webglBridge.cleanup(); } },  
 735059: ($0, $1, $2, $3) => { if (typeof window.webglBridge !== 'undefined' && window.webglBridge.setViewport) { window.webglBridge.setViewport($0, $1, $2, $3); } },  
 735196: ($0, $1, $2, $3) => { if (typeof window.webglBridge !== 'undefined' && window.webglBridge.clear) { window.webglBridge.clear($0, $1, $2, $3); } },  
 735321: () => { if (typeof window.webglBridge !== 'undefined' && window.webglBridge.present) { window.webglBridge.present(); } },  
 735436: () => { if (typeof window.webglBridge !== 'undefined' && window.webglBridge.initialize) { return window.webglBridge.initialize() ? 1 : 0; } return 0; },  
 735582: () => { if (typeof window.webglBridge !== 'undefined' && window.webglBridge.createShaders) { return window.webglBridge.createShaders() ? 1 : 0; } return 0; },  
 735734: () => { if (typeof window.webglBridge !== 'undefined' && window.webglBridge.createBuffers) { return window.webglBridge.createBuffers() ? 1 : 0; } return 0; },  
 735886: ($0, $1, $2, $3, $4, $5, $6, $7) => { if (typeof window.webglBridge !== 'undefined' && window.webglBridge.renderQuad) { window.webglBridge.renderQuad($0, $1, $2, $3, $4, $5, $6, $7); } },  
 736037: () => { if (!window.textureBridge) { window.textureBridge = new TextureBridge(); } window.textureBridge.initialize(); },  
 736151: () => { if (window.textureBridge) { window.textureBridge.shutdown(); delete window.textureBridge; window.textureBridge = null; } },  
 736276: ($0, $1) => { if (window.textureBridge) { return window.textureBridge.loadTexture(UTF8ToString($0), $1) ? 1 : 0; } return 0; },  
 736391: ($0) => { return window.textureBridge ? window.textureBridge.getTextureWidth($0) : 0; },  
 736471: ($0) => { return window.textureBridge ? window.textureBridge.getTextureHeight($0) : 0; },  
 736552: ($0) => { return window.textureBridge ? window.textureBridge.getTextureFormat($0) : 0; },  
 736633: ($0) => { return window.textureBridge ? window.textureBridge.hasTransparency($0) : 0; },  
 736713: ($0) => { if (window.textureBridge) { window.textureBridge.unloadTexture($0); } },  
 736787: ($0, $1) => { if (window.playLevelMidiBuffer) { var bytes = HEAPU8.slice($0, $0 + $1); window.playLevelMidiBuffer(bytes); } },  
 736901: () => { window.exportSaveData(); },  
 736930: () => { window.importSaveData(); },  
 736959: () => { window.toggleFullscreen(); },  
 736990: () => { window.toggleAspectRatio(); },  
 737022: () => { return document.fullscreenElement ? 1 : 0; },  
 737069: () => { return document.fullscreenElement ? 0 : 1; },  
 737116: () => { return window.forceOriginalAspect ? 0 : 1; },  
 737163: () => { return window.forceOriginalAspect ? 1 : 0; },  
 737210: () => { var iOS = /iPad|iPhone|iPod/.test(navigator.userAgent) || (navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1); if (iOS) return 0; return document.fullscreenElement ? 1 : 0; },  
 737403: () => { var iOS = /iPad|iPhone|iPod/.test(navigator.userAgent) || (navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1); if (iOS) return 0; return document.fullscreenElement ? 0 : 1; },  
 737596: () => { return window.forceOriginalAspect ? 0 : 1; },  
 737643: () => { return window.forceOriginalAspect ? 1 : 0; },  
 737690: ($0) => { console.log('[Gamepad C++] Controller ' + $0 + ' connected'); },  
 737756: ($0) => { console.log('[Gamepad C++] Controller ' + $0 + ' disconnected'); },  
 737825: () => { return window.devicePixelRatio ? window.devicePixelRatio : 1.0; },  
 737893: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 738108: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 738255: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 738489: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL2.audioContext); } } } return SDL2.audioContext === undefined ? -1 : 0; },  
 739041: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
