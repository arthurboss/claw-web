...
// include: /tmp/tmpamnd3ysb.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/tmp/claw-web-rename/Build_Release/openclaw.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_/tmp/claw-web-rename/Build_Release/openclaw.data');
      }
      Module['addRunDependency']('datafile_/tmp/claw-web-rename/Build_Release/openclaw.data');
...
// end include: /tmp/tmpamnd3ysb.js
